...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_POWER_VMX_SIMD_FUNCTION_IS_GREATER_EQUAL_HPP_INCLUDED
#define BOOST_SIMD_ARCH_POWER_VMX_SIMD_FUNCTION_IS_GREATER_EQUAL_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
   {
      ...
      BOOST_FORCEINLINE result operator()( ) const BOOST_NOEXCEPT
      {
       result lt = vec_cmplt(a0.storage(),a1.storage());
        return !lt;
      }
   };
