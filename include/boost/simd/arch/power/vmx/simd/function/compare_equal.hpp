...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_POWER_VMX_SIMD_FUNCTION_COMPARE_EQUAL_HPP_INCLUDED
#define BOOST_SIMD_ARCH_POWER_VMX_SIMD_FUNCTION_COMPARE_EQUAL_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
   {
      ...
      {
       return result(vec_all_eq(a0.storage(),a1.storage()));
      }
   };
