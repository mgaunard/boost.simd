...
*/
//==================================================================================================
#ifndef BOOST_SIMD_ARCH_POWER_VMX_SIMD_FUNCTION_LOOKUP_HPP_INCLUDED
#define BOOST_SIMD_ARCH_POWER_VMX_SIMD_FUNCTION_LOOKUP_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
   ...
   BOOST_DISPATCH_OVERLOAD(lookup_
                          ...
                          , bs::pack_<bd::ints8_<A1>, bs::vmx_>
                          )
   {
      BOOST_FORCEINLINE A0 operator()( const A0& a0, const A0& a1) const BOOST_NOEXCEPT
      {
        using u8type = A1::template rebind<unsigned char>;
       return vec_perm(a0.storage(),a0.storage(), bitwise_cast<u8type>(a1)());
      }
   };
